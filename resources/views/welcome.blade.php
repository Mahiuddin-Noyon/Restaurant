                            ...
                            <div class="section-header">
                                ...
                                <ul id="filter-list" class="clearfix">
                                    <li class="filter" data-filter="all">All</li>
                                        <li class="filter" data-filter="#">Testing<span class="badge"></span></li>
                                </ul><!-- @end #filter-list -->
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <ul id="menu-pricing" class="menu-price">
                            ...
                            <li class="item" id="">
                                <a href="#">
                                    <img src="{{asset('frontend/images/food1.jpg')}}" class="img-responsive" alt="Item" style="height: 300px; width: 369px;" >
